    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "EmpathAI",
          url: "https://friendlypal.lovable.app",
          description: "Private AI emotional companion for teens and young adults — chat, mood mirror, healing toolkit, and crisis support.",
          sameAs: [],
        }),
      },
    ],
